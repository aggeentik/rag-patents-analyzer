...
├── eval_vis.py                       # Results visualization and report generation
├── generate_dataset.py               # Synthetic QA dataset generator
├── datasets/                         # Test datasets
│   ├── generated_testset.json       # Latest synthetic dataset (JSON)
│   ├── generated_testset.csv        # Latest synthetic dataset (CSV)
│   └── ragas_dataset_20.json        # Curated dataset (20 questions)
├── experiments/                      # Timestamped evaluation results
│   ├── ragas_results_TIMESTAMP.json # Results JSON
│   └── evaluation_report_TIMESTAMP.md # Markdown report
...
Synthetic dataset generated by RAGAS TestsetGenerator from patent chunks. Generated per-document to prevent cross-document hallucinations.

### ragas_dataset_20.json
Curated test set with 20 questions across 5 categories:
...
- **Full evaluation documentation:** `docs/4. EVALS.md`
- **RAGAS docs:** https://docs.ragas.io/
- **Project architecture:** `docs/2. RETRIEVAL_GENERATION.md`
- **Pipeline walkthrough:** `docs/3. E2E_PIPELINE.md`
